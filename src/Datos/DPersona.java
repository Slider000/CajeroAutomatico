...
public class DPersona {
    ...
    public void setDNI(String DNI) throws IOException {
        Scanner sc = new Scanner(System.in);
        RegistrarDatos Reg = new RegistrarDatos(this.Base);
        while (Reg.BuscarCadena(DNI) || ((DNI.length() != 10 || esNumero(DNI) == false) && DNI.length() != 0)) {
            if (Reg.BuscarCadena(DNI)) {
                System.out.println("---Ya existe\nIngrese CEDULA: ");
            } else if ((DNI.length() != 10 || esNumero(DNI) == false) && DNI.length() != 0) {
                System.out.println("---Dato incorrecto\nIngrese CEDULA: ");
            }
            DNI = sc.next();
        }
    ...
    public void RegistrarPersona() throws IOException {
        RegistrarDatos Reg = new RegistrarDatos(this.Base);
        String Cadena = "|" + this.id + "|" + this.DNI + "|" + this.Nombre
    ...
    public void modificarRegistro(String id) throws IOException {
        ...
        try {
            ...
            Scanner sc = new Scanner(System.in);
            System.out.println("Ingrese su nuevo CEDULA");
            this.setDNI(sc.next());
            ...
            String newString = "|" + id + "|" + this.getDNI() + "|" + this.getNombre() + "|"
