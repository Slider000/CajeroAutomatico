...
public class CAhorroPesos extends DCuentas{
     private int intCantCAhorroPesos;
   

    public CAhorroPesos(String Tipo) throws IOException {
        setBase("AhorroPesos");
    ...
    public int getIntCantCAhorroPesos() {
        return intCantCAhorroPesos;
    }

    public void setIntCantCAhorroPesos(int intCantCAhorroPesos) {
        this.intCantCAhorroPesos = intCantCAhorroPesos;
    }
    
      // Registrar Cuentas.
       public void RegistrarCuentaPesos() throws IOException{
        RegistrarDatos Reg = new RegistrarDatos(getBase());
        String Cadena = "|" + getIdcuenta() +"|" + getIntCantCAhorroPesos() +"|" + getFec_in() + "|";
        ...
        try{
          ...
          //leyendo todas las lineas de archivo de texto de entraas dentro de oldContent   
               ...
               while (line != null) 
            {
              ...
              String montOld = registroLinea.substring(3,10);
